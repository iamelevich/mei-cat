...
import { CcSchema } from "./cc";
import { ChanSchema } from "./chan";
import { ChanPrSchema } from "./chanPr";
import { CueSchema } from "./cue";
import { HexSchema } from "./hex";
import { MarkerSchema } from "./marker";
import { MetaTextSchema } from "./metaText";
import { NoteOffSchema } from "./noteOff";
import { NoteOnSchema } from "./noteOn";
import { PortSchema } from "./port";
import { ProgSchema } from "./prog";
import { SeqNumSchema } from "./seqNum";
import { TrkNameSchema } from "./trkName";
import { VelSchema } from "./vel";
