	...
	v.lazy(() =>
		v.intersect([
			v.object({
				 ...
				 */
				postBox: v.optional(v.union([v.array(PostBoxSchema), PostBoxSchema])),
				/**
				 ...
				 */
				postCode: v.optional(
					v.union([v.array(PostCodeSchema), PostCodeSchema]),
				),
				/**
				 ...
				 */
				street: v.optional(v.union([v.array(StreetSchema), StreetSchema])),
			}),
			ModelGeogNamePartSchema,
		]),
	);
