...
import { type BiblListData, BiblListSchema } from "./biblList";
import { type EventData, EventSchema } from "./event";
import { type NameData, NameSchema } from "./name";
...
export const EventListSchema: v.GenericSchema<EventListData> = v.lazy(() =>
	v.intersect([
		...
		v.object({
			 ...
			 */
			event: v.optional(v.union([v.array(EventSchema), EventSchema])),
			/**
