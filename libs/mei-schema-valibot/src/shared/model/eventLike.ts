...
import { type TabGrpData, TabGrpSchema } from "../../stringtab/element/tabGrp";
import { type BarLineData, BarLineSchema } from "../element/barLine";
import { type ChordData, ChordSchema } from "../element/chord";
import { type ClefData, ClefSchema } from "../element/clef";
import { type ClefGrpData, ClefGrpSchema } from "../element/clefGrp";
import { type CustosData, CustosSchema } from "../element/custos";
import { type NoteData, NoteSchema } from "../element/note";
import { type PadData, PadSchema } from "../element/pad";
import { type RestData, RestSchema } from "../element/rest";
import { type SpaceData, SpaceSchema } from "../element/space";
 ...
 */
export const ModelEventLikeSchema: v.GenericSchema<ModelEventLikeData> = v.lazy(
	() =>
		v.intersect([
			v.object({
				/**
				 ...
				 */
				barLine: v.optional(v.union([v.array(BarLineSchema), BarLineSchema])),
				/**
				 ...
				 */
				chord: v.optional(v.union([v.array(ChordSchema), ChordSchema])),
				/**
				 ...
				 */
				custos: v.optional(v.union([v.array(CustosSchema), CustosSchema])),
				/**
				 ...
				 */
				pad: v.optional(v.union([v.array(PadSchema), PadSchema])),
				/**
				 ...
				 */
				tabGrp: v.optional(v.union([v.array(TabGrpSchema), TabGrpSchema])),
			}),
