...
import { type ModelAnnotLikeData, ModelAnnotLikeSchema } from "./annotLike";
import { type ModelBiblLikeData, ModelBiblLikeSchema } from "./biblLike";
import { type ModelDateLikeData, ModelDateLikeSchema } from "./dateLike";
import { type ModelDimLikeData, ModelDimLikeSchema } from "./dimLike";
import {
...
} from "./measurementLike";
import { type ModelNameLikeData, ModelNameLikeSchema } from "./nameLike";
import {
	type ModelRelationLikeData,
	ModelRelationLikeSchema,
} from "./relationLike";
import { type ModelRendLikeData, ModelRendLikeSchema } from "./rendLike";
