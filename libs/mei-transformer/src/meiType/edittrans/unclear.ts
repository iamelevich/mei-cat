 ...
 */
export const UnclearSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	...
	Type.Object(
		{
			 ...
			 * @see https://music-encoding.org/guidelines/v5/elements/unclear.html
			 */
			unclear: Type.Optional(NotImplementedTagSchema), // TODO: Not implemented because of circular dependency

			// Note: The unclear element can contain many more element types according to the MEI spec,
...
export type Unclear = Static<typeof UnclearSchema>;
