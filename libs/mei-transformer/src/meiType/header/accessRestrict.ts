...
/**
 * Describes restrictions on access to the encoded material.
 * @see https://music-encoding.org/guidelines/v5/elements/accessRestrict.html
 */
export const AccessRestrictSchema = Type.Intersect(
	[
		StandardTagSchema,
		AttrCommonSchema,
		...
		Type.Object(
			{
				 ...
				 */
				p: Type.Optional(
					Type.Union([Type.Ref("p"), Type.Array(Type.Ref("p"))]),
				),
				/**
				 ...
				 */
				q: Type.Optional(
					Type.Union([Type.Ref("q"), Type.Array(Type.Ref("q"))]),
				),
				/**
