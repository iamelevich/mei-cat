 ...
 */
export const ContentItemSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrBiblSchema,
	AttrLangSchema,
	Type.Object(
		{
			 ...
			 */
			corr: Type.Optional(Type.String()),
			/**
			 ...
			 */
			handShift: Type.Optional(Type.String()),
			/**
			 ...
			 */
			orig: Type.Optional(Type.String()),
			/**
			 ...
			 */
			subst: Type.Optional(Type.String()),
			/**
			 ...
			 */
			supplied: Type.Optional(Type.String()),
			/**
			 ...
			 */
			unclear: Type.Optional(Type.String()),
			 ...
			 */
			bloc: Type.Optional(
				Type.Union([Type.Ref("bloc"), Type.Array(Type.Ref("bloc"))]),
			),
			/**
