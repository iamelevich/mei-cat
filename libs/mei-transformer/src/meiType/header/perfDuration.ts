 ...
 */
export const PerfDurationSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrBiblSchema,
	AttrFacsimileSchema,
	...
	Type.Object(
		{
			 ...
			 * @see https://music-encoding.org/guidelines/v5/elements/perfDuration.html#isodur
			 */
			isodur: Type.Optional(Type.String()),
		},
		{ additionalProperties: false },
	),
	Type.Object(
		{
			// macro.struc-unstrucContent - model.headLike, model.pLike, text, model.textPhraseLike.limited
			/**
...
export type PerfDuration = Static<typeof PerfDurationSchema>;
