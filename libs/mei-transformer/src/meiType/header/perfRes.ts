 ...
 */
export const PerfResSchema = Type.Recursive((Self) =>
	Type.Intersect([
		StandardTagSchema,
		AttrCommonSchema,
		...
		Type.Object(
			{
				// Zero or more choice of text OR model.textPhraseLike.limited OR perfRes elements
				 ...
				 */
				locus: Type.Optional(
					Type.Union([LocusSchema, Type.Array(LocusSchema)]),
				),
				/**
				 ...
				 */
				stamp: Type.Optional(
					Type.Union([StampSchema, Type.Array(StampSchema)]),
				),
				...
				// Recursive perfRes elements
				/**
				 * Name of an instrument on which a performer plays, a performer's voice range, or a standard performing ensemble designation.
				 * @see https://music-encoding.org/guidelines/v5/elements/perfRes.html
				 */
				perfRes: Type.Optional(Type.Union([Self, Type.Array(Self)])),
			},
...
export type PerfRes = Static<typeof PerfResSchema>;
