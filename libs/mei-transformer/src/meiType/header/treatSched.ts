 ...
 */
export const TreatSchedSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrBiblSchema,
	AttrDatableSchema,
	...
	Type.Object(
		{
			// Choice between structured content and mixed content
			// Structured content: head (zeroOrMore) + choice between eventList and p (zeroOrMore)
			/**
			...
			// Mixed content: text + model.textPhraseLike.limited elements
			/**
...
export type TreatSched = Static<typeof TreatSchedSchema>;
