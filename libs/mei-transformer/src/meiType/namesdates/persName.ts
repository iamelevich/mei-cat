 ...
 */
export const PersNameSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrBiblSchema,
	AttrEvidenceSchema,
	...
	Type.Object(
		{
			...
			// rng:zeroOrMore - choice of text OR model.textPhraseLike OR model.editLike OR model.transcriptionLike OR model.persNamePart
			...
			// model.persNamePart elements - These would be specific personal name components
			// Note: These are placeholder references since the actual schemas may not be implemented yet
			// For greater specificity, use foreName, famName, genName, addName, nameLink, and roleName elements
		},
		{ additionalProperties: false },
	),
]);

export type PersName = Static<typeof PersNameSchema>;
