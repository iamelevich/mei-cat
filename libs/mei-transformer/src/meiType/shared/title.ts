	...
	Type.Object(
		{
			 ...
			 */
			choice: Type.Optional(Type.Union([Type.Ref("choice"), Type.Array(Type.Ref("choice"))])),
			 ...
			 */
			damage: Type.Optional(Type.Union([Type.Ref("damage"), Type.Array(Type.Ref("damage"))])),
			...
			titlePart: Type.Optional(
				Type.Union([Type.Ref("titlePart"), Type.Array(Type.Ref("titlePart"))]),
			),
		},
