 ...
 */
export const SegSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrFacsimileSchema,
	AttrLangSchema,
	Type.Object(
		{
			...
			// rng:zeroOrMore - choice of text OR model.editLike OR model.sylLike OR model.textPhraseLike OR model.transcriptionLike
			...
			// model.sylLike elements
			/**
			 * Individual lyric syllable.
			 * @see https://music-encoding.org/guidelines/v5/elements/syl.html
			 */
			syl: Type.Optional(Type.Union([SylSchema, Type.Array(SylSchema)])),
		},
		{ additionalProperties: false },
	),
]);

export type Seg = Static<typeof SegSchema>;
