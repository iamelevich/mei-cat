 ...
 */
export const SylSchema = Type.Intersect([
	StandardTagSchema,
	AttrCommonSchema,
	AttrFacsimileSchema,
	AttrLangSchema,
	...
	Type.Object(
		{
			 ...
			 */
			app: Type.Optional(Type.Union([AppSchema, Type.Array(AppSchema)])),
...
export type Syl = Static<typeof SylSchema>;
