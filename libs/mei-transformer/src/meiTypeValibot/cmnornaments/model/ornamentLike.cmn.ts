...
export const ModelOrnamentLikeCmnSchema: v.GenericSchema<ModelOrnamentLikeCmnData> =
	v.lazy(() =>
		v.object({
			 ...
			 */
			mordent: v.optional(v.union([MordentSchema, v.array(MordentSchema)])),
			/**
			 ...
			 */
			trill: v.optional(v.union([TrillSchema, v.array(TrillSchema)])),
			/**
			 ...
			 */
			turn: v.optional(v.union([TurnSchema, v.array(TurnSchema)])),
		}),
	);
