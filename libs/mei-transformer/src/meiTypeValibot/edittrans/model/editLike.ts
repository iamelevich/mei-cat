...
import { type ChoiceData, ChoiceSchema } from "../choice";
import { type SubstData, SubstSchema } from "../subst";
 ...
 */
export const EditLikeSchema: v.GenericSchema<EditLikeData> = v.object({
	/**
