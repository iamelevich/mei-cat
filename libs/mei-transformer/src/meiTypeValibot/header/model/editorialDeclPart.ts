...
export const ModelEditorialDeclPartSchema: v.GenericSchema<ModelEditorialDeclPartData> =
	v.object({
		...
		correction: v.optional(
			v.union([
				v.lazy(() => CorrectionSchema),
				v.array(v.lazy(() => CorrectionSchema)),
			]),
		),
		/**
		...
		interpretation: v.optional(
			v.union([
				v.lazy(() => InterpretationSchema),
				v.array(v.lazy(() => InterpretationSchema)),
			]),
		),
		/**
		...
		normalization: v.optional(
			v.union([
				v.lazy(() => NormalizationSchema),
				v.array(v.lazy(() => NormalizationSchema)),
			]),
		),
		/**
		...
		segmentation: v.optional(
			v.union([
				v.lazy(() => SegmentationSchema),
				v.array(v.lazy(() => SegmentationSchema)),
			]),
		),
		/**
		...
		stdVals: v.optional(
			v.union([
				v.lazy(() => StdValsSchema),
				v.array(v.lazy(() => StdValsSchema)),
			]),
		),
	});
