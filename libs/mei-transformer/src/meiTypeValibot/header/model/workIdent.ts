	...
	() =>
		v.intersect([
			v.object({
				 ...
				 */
				key: v.optional(v.union([v.array(KeySchema), KeySchema])),
				/**
				...
				mensuration: v.optional(
					v.union([v.array(MensurationSchema), MensurationSchema]),
				),
				/**
				 ...
				 */
				meter: v.optional(v.union([v.array(MeterSchema), MeterSchema])),
				/**
