...
import { type WorkData, WorkSchema } from "..";

/**
 * Collects work-like elements.
 * @see https://music-encoding.org/guidelines/v5/model-classes/model.workLike.html
 */
export const ModelWorkLikeSchema: v.GenericSchema<ModelWorkLikeData> = v.object(
	{
		/**
		 ...
		 */
		work: v.optional(
			v.union([v.lazy(() => WorkSchema), v.array(v.lazy(() => WorkSchema))]),
		),
	},
);
