...
export const ModelPersNamePartSchema: v.GenericSchema<ModelPersNamePartData> =
	v.lazy(() =>
		v.object({
			 ...
			 */
			addName: v.optional(v.union([AddNameSchema, v.array(AddNameSchema)])),
			/**
			 ...
			 */
			famName: v.optional(v.union([FamNameSchema, v.array(FamNameSchema)])),
			/**
			 * Contains a forename, given or baptismal name.
			 * @see https://music-encoding.org/guidelines/v5/elements/foreName.html
			 */
			foreName: v.optional(v.union([ForeNameSchema, v.array(ForeNameSchema)])),
			/**
			 ...
			 */
			genName: v.optional(v.union([GenNameSchema, v.array(GenNameSchema)])),
			/**
			 ...
			 */
			roleName: v.optional(v.union([RoleNameSchema, v.array(RoleNameSchema)])),
		}),
	);
