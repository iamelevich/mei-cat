 ...
 */
export const GroupSchema: v.GenericSchema<GroupData> = v.intersect([
	GroupBaseSchema,
	v.object({
		/**
		 ...
		 */
		group: v.optional(
			v.union([v.lazy(() => GroupSchema), v.array(v.lazy(() => GroupSchema))]),
		),
		/**
		 ...
		 */
		music: v.optional(
			v.union([v.lazy(() => MusicSchema), v.array(v.lazy(() => MusicSchema))]),
		),
	}),
]);
