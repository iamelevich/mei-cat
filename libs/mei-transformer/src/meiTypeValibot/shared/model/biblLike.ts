...
import { type BiblData, BiblSchema } from "../element/bibl";
import { type BiblStructData, BiblStructSchema } from "../element/biblStruct";
 ...
 */
export const ModelBiblLikeSchema: v.GenericSchema<ModelBiblLikeData> = v.lazy(
	() =>
		v.object({
			/**
