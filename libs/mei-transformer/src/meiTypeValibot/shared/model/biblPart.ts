	...
	() =>
		v.intersect([
			v.object({
				 ...
				 */
				creation: v.optional(
					v.union([CreationSchema, v.array(CreationSchema)]),
				),
				/**
				 ...
				 */
				genre: v.optional(v.union([GenreSchema, v.array(GenreSchema)])),
				/**
				...
				recipient: v.optional(
					v.union([RecipientSchema, v.array(RecipientSchema)]),
				),
				/**
				...
				relatedItem: v.optional(
					v.union([RelatedItemSchema, v.array(RelatedItemSchema)]),
				),
				/**
				 ...
				 */
				textLang: v.optional(
					v.union([TextLangSchema, v.array(TextLangSchema)]),
				),
			}),
			ModelEditionLikeSchema,
			ModelRespLikeSchema,
