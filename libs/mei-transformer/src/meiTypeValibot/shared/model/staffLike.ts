...
export const ModelStaffLikeSchema: v.GenericSchema<ModelStaffLikeData> =
	v.object({
		 ...
		 */
		staff: v.optional(
			v.union([v.lazy(() => StaffSchema), v.array(v.lazy(() => StaffSchema))]),
		),
	});
