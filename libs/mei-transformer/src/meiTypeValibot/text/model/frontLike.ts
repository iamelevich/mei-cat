...
/**
 * Groups elements used to represent the front matter of a text.
 * @see https://music-encoding.org/guidelines/v5/model-classes/model.frontLike.html
 */
export const FrontLikeSchema = v.object({
  /**
...
export type FrontLikeData = v.InferOutput<typeof FrontLikeSchema>;
